...
const menuItems: MenuItem[] = [
  ...
  { path: '/exams', label: 'Examens', icon: FileText },
  { path: '/results', label: 'Résultats', icon: ClipboardList },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 flex items-center border-b border-gray-200 h-16 shrink-0">
            <Link to="/dashboard" onClick={handleLinkClick} className="flex items-center gap-2 w-full justify-center">
              ...
              <span className={cn('font-bold text-xl whitespace-nowrap transition-opacity', sidebarOpen ? 'opacity-100' : 'lg:opacity-0')}>
          ...
          <div className="p-2 border-t border-gray-200 shrink-0">
            <div className="flex items-center p-2 rounded-lg hover:bg-gray-50">
              ...
              <div className={cn('ml-3 overflow-hidden transition-opacity', sidebarOpen ? 'opacity-100' : 'lg:opacity-0')}>
                <p className="text-sm font-semibold text-gray-800 truncate">Century Dashboard</p>
                <p className="text-xs text-gray-500 truncate">Gestion éducative</p>
              </div>
            </div>
          </div>
        </div>
